This project demonstrates GPU acceleration of image-processing workloads using C++, CUDA, and OpenCV. It implements two-pass Gaussian blur on both CPU and GPU and compares execution performance.
### Prerequisites
...
The displayed image is of of mona lisa blurred. The original image is the image 'Mona_Lisa,_by_Leonardo_da_Vinci,_from_C2RMF_retouched.jpg.webp' from the website 'https://en.wikipedia.org/wiki/Mona_Lisa'
